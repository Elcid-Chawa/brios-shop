        ...
        <div class="main">
            <div class="intro-slider-container mb-5">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" 
                    ...
                    <div class="intro-slide" style={{backgroundImage: `url(/assets/images/demos/demo-4/slider/slide-1.png)`}}>
                    ...
                    <div class="intro-slide" style={{backgroundImage: `url(/assets/images/demos/demo-4/slider/slide-2.png)`}}>
                        <div class="container intro-content">
                            <div class="row justify-content-end">
                                <div class="col-auto col-sm-7 col-md-6 col-lg-5">
            ...
            <div class="container">
                <div class="cta cta-border mb-5" style={{backgroundImage: `url(assets/images/demos/demo-4/bg-1.jpg)`}}>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style={{backgroundImage: `url(/assets/images/demos/demo-4/deal/bg-1.jpg)`}}>
                            <div class="deal-top">
                    ...
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style={{backgroundImage: `url(/assets/images/demos/demo-4/deal/bg-2.jpg)`}}>
                            <div class="deal-top">
